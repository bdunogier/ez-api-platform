...
class RestBasedValueObjectNormalizer implements NormalizerInterface, DenormalizerInterface, SerializerAwareInterface
{
     ...
     */
    public function __construct(NormalizerInterface $decorated, ValueObjectVisitorDispatcher $visitor)
    {
